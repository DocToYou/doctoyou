...
export const Home = () => {
  ...
  const handleClick = (e) => {
    if (!isMobileDevice()) {
      e.preventDefault(); 
      alert(
        "Calling is not supported on this device. Please use a mobile phone."
      );
    }
  };
  return (
    <div className="lg:bg-[#e4ebf2] h-screen">
      ...
      <Navbar />
      <div className="shadow-xl/30 relative flex mt-5 mx-10 min-h-[500px] rounded-2xl bg-gradient-to-tl from-[#5966a1] to-[#020460] ">
        <div className="lg:w-1/2 p-3 lg:p-7 relative overflow-hidden">
          ...
          <div className="relative w-full lg:w-auto">
            <div className="flex items-center py-2 border border-black rounded-lg text-sm text-[#1815a1] cursor-pointer relative">
              ...
              <label className="text-[#1815a1] lg:mr-7" htmlFor="dateTime">
                Date & Time
              </label>
              <svg
                xmlns="http://www.w3.org/2000/svg"
        ...
        <div
          className="bg-gradient-to-b from-white to-[#e4ebf2]"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center px-10 pb-45 lg:px-20 lg:pb-7 w-full">
              <div className="lg:space-y-9 lg:pt-2 pt-12 relative ">
                ...
                <div className="flex justify-center py-3 lg:pt-5 lg:justify-start">
                  <a href="tel:+919344688406" onClick={handleClick}
                  className="bg-red-500 hover:bg-red-600 text-[14px]  px-18 py-3 text-white lg:px-16 lg:py-3 rounded-xl font-semibold ">
