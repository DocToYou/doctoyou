...
import { Cato } from '../components/home/Cato';
...
export const Home = () => {
  ...
  return (
    <div className="lg:bg-[#e4ebf2] h-screen">
      ...
      <Navbar handleScrollToServices={handleScrollToServices}/>
      <div className="relative flex mt-5 mx-10 min-h-[500px] rounded-2xl bg-gradient-to-tl from-[#5966a1] to-[#020460] ">
        <div className="lg:w-1/2 p-3 lg:p-7 relative overflow-hidden">
          ...
          <h2 className="text-2xl lg:text-6xl font-bold lg:pl-5 lg:pb-3 pl-2 text-white font-cursiv">
